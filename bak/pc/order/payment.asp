			...
			<div class="payment-area">
				<div class="sub-step mb80">
					<ul>
						...
						<li class="step2"><img src="../../resource/images/sub/ico_order_step02.png" alt="배송정보"></li>
						<li class="step3"><img src="../../resource/images/sub/ico_order_step03_on.png" alt="결제하기"></li>
