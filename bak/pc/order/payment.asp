			...
			<div class="payment-area">
				<div class="sub-step mb80">
					<ul>
						...
						<li class="step3"><img src="http://brics.styleship.com/pc/resource/images/sub/ico_order_step03_on.png" alt="결제하기"></li>
				...
				<section class="order__con">
					...
					<div class="payway__box">
						<div class="info">
							...
							<ul>
								<li>- 결제금액이 5만원이상일 경우 결제대금예치(에스크로)를 통해 안전하게 구매하실 수 있습니다.</li>
								<li>- 상품을 받으신 후 구매결정에 대한 메일이 발송됩니다.메일을 받으신 후 구매와 취소에 대한 결정을 해주셔야 합니다.</li>
							</ul>
						</div>
					</div>
					<div class="btn-area">
