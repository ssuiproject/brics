...
<!-- #include virtual = "../../layout/html_header.asp" -->
	...
	<script src="../../resource/js/lib/jquery.ui.1.11.4.min.js"></script>
		...
		<div id="subContents">
			...
			<div class="cancel-area">
				<ul class="mypage-lnb">
					...
					<li><a href="" class="on">취소/반품내역</a></li>
					...
					<table class="list__table">
						...
						<tbody>
							<tr>
								...
								<td>11,200원</td>
								<td>48,800원</td>
								<td class="pcolor">취소완료</td>							
							</tr>
							<tr class="add-info">
								<td colspan="7" >
									<div class="deliy w-50">
										<strong>배송비 3,000원 / <span class="pcolor">입금전주문취소</span></strong>
									</div>
