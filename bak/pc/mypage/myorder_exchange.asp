...
<!-- #include virtual = "../layout/doc_header.asp" -->	
		...
		<div id="subContents">
			...
			<div class="myorder-area">
				...
				<form action="">
					<fieldset>
						<legend class="acc-hidden">교환 신청 폼</legend>
						...
						<section class="my__con">
							<h3 class="tit-sub-style5">교환 신청하기</h3>
							<table class="list__table">
								<caption class="acc-hidden">교환 리스트 테이블</caption>
								<colgroup>
									<col style="width:1%">
									<col style="width:12%">
									<col>
								...
								<thead>
									...
									<th class="pcolor"><strong>교환내용</strong></th>
								</thead>
								<tbody>
									<tr>
										<td>
										...
										<td>48,800원</td>
										<td>48,0000원</td>							
										<td><strong>48,0000원</strong></td>							
										<td>
											<span class="pcolor">교환옵션선택</span>
											<div class="option">
									...
									<tr class="reason__input">
										<td colspan="8">
											<select name="" id="" class="select__style2">
												<option value="">교환사유 선택</option>
											</select>
											<input type="text" name="" id="" class="input__style2" placeholder="교환사유를 입력해주세요.">
										</td>
									</tr>
									<tr>
										<td>
						...
						<section class="my__con">
							<h3 class="tit-sub-style">반품/교환 배송비 결제방법 선택</h3>
						...
						<section class="my__con">
							<h3 class="tit-sub-style">반품/교환 관련 안내 사항</h3>	
							<div class="payway__box">
						...
						<section class="my__con">
							<h3 class="tit-sub-style">반품/교환처 주소</h3>	
							<div class="payway__box">
								<div class="return-info">
									<ul>
										<li>
