...
<!-- #include virtual = "../pc/layout/doc_header.asp" -->	
		...
		<div id="subContents">
			<div class="join-complete">
				<h2>회원가입이 완료되었습니다.</h2>
				<p>brics
					dddd1234 회원님, Bric’s의 회원이 되신 것을 축하드립니다. <br>
					다양한 이벤트와 정보를 제공받으실 수 있으며, 회원 정보 변경은 마이페이지에서 하실 수 있습니다.			
				</p>
				<div class="btn-area">
					<a class="btn__style2 btn__style--bg" href="login.asp">홈페이지 로그인 하기</a>
				</div>
			</div>
		</div>
		<!-- // end of :: contents -->
