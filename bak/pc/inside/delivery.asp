		...
		<div id="subContents">
			<div class="sub__wrap">
				<div class="sub-lnb">
					...
					<ul>
						<li><a href="">회원혜택 안내</a></li><!-- 현재페이지 .on -->
						<li><a href="" class="on">배송안내</a></li> 
						<li><a href="">취소/교환/반품 안내</a></li>
						<li><a href="">A/S 안내</a></li>
					</ul>
				</div>
				<div class="sub-con">
					<h3 class="tit-style5">배송안내</h3>
					<div class="delivery-area">
						<table class="etc__table">
							...
							<tbody>
								<tr>
									<th>배송방식</th>
									<td class="left">스타일쉽 BRICS 온라인스토어 물류센터 (CJ 대한통운)</td>
								</tr>
								<tr>
									<th>배송지역</th>
									<td class="left">전국 (일부지역 제외)</td>
								</tr>
								<tr>
									<th>배송비</th>
									<td class="left">3,000원 (30,000원 이상 구입 시 무료배송)</td>
								</tr>
								<tr>
									<th>배송기일</th>
									<td class="left">
