		...
		<div id="subContents">
			<div class="sub__wrap">
				...
				<select name="" id="" class="sub-lnb">
					<option value="">회원혜택 안내</option>
					<option value="">배송안내</option>
					<option value="" selected>취소/교환/반품 안내</option>
					<option value="">A/S 안내</option>
				</select>
				<div class="sub-con">
					<h3 class="tit-style4">취소/교환/반품 안내</h3>
					<div class="cancelinfo-area">
						<table class="etc__table">
							<caption class="acc-hidden">취소/교환/반품 안내 테이블</caption>
							<tbody>
								<tr>
									<td class="left define">
										<dl>
											<dt>교환/반품 기간</dt>
											<dd>
												고객님의 단순변심으로 인한 교환ㆍ반품은, 실제 상품 등을 수령하신 날부터 7일이내. <br>
												단, 상품 안내 페이지에 표시된 교환/반품 기간이 7일보다 긴 경우에는 그 기간 고객님이 받으신 상품 등의 내용이 표시·광고 내용과 다르거나 계약내용과 다르게 이행된 경우에는 상품 등을 수령한 날 부터 3개월 이내, <br>
									...
									<td class="left define">
										<dl>
											...
											<dd>
												...
												2. 반품상품을 BRICS 온라인스토어가 수령한 날로부터 3영업일이 경과하도록 상품대금을 환불하지 않았을 경우 <br><br>
