...
<!-- #include virtual = "/mo/layout/html_header.asp" -->
	...
	<!-- 개별 css, js -->
	<script src="/mo/resource/js/pages/order.js"></script>
		...
		<div id="subContents">
			<div class="sub-step order">
				<ul>
					...
					<li class="step2 on"><i><img src="/mo/resource/images/sub/ico_order_step02_on.png" alt=""></i>배송정보</li>
							...
							<ul class="list__basic">
								<li>	
									...
									<div class="pd-info">
										...
										<dl class="define">
											<dt>쿠폰조회</dt>
											<dd><a href="javascript:void(0)" class="coupon-btn view btn__style--bd">쿠폰조회/적용</a></dd>
										</dl>											
									</div>
								</li>
								<li>	
								...
								<li class="mileage">
									<dl class="define">
										<dt><label for="">적립금</label></dt>
										<dd>
											<input type="text" name="" id="">&nbsp;&nbsp;원 사용
											<p>(사용 가능한 적립금 0원)</p>
											<div class="check-box">
